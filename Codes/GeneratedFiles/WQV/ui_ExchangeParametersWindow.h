...
public:
    ...
    {
        ExchangeParametersWindow->setWindowTitle(QApplication::translate("ExchangeParametersWindow", "Dialog", 0));
        action_Remove->setText(QApplication::translate("ExchangeParametersWindow", "&Remove", 0));
        groupBox->setTitle(QApplication::translate("ExchangeParametersWindow", "Solic aqueous exchange parameters", 0));
